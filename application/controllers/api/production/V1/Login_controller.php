...
class Login_controller extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('production/V1/Login_model');
    }
    ...
    private function _HCClientLogin($body)
    {
        ...
        return $this->client->sendRequest(
            ...
            0,
            'POST',
            $this->appConfigProduction->username,
            $this->appConfigProduction->password,
    ...
    public function create_post()
    {
        ...
        $referenceID = $this->_generateReferenceID("production", "LOGIN");
        ...
        if ($referenceID !== null) {
            ...
            $this->createSysLog('production', $referenceID, $_SERVER['REQUEST_METHOD'], __CLASS__, __METHOD__, 'LOGIN', '', '', '', $resp['responseInfo']);
        } else {

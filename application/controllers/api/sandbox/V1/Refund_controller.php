...
class Refund_controller extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('sandbox/V1/Refund_model');
    }
    ...
    private function _HCClientPayment($body = [])
    {
        ...
        return $this->client->sendRequest(
            ...
            $this->appConfigSandbox->refundURL,
            $loginBody,
            $body,
            0,
            'POST',
    ...
    public function create_post()
    {
        ...
        $referenceID = $this->_generateReferenceID("sandbox", "REFUND");

        if ($referenceID !== null) {

            $resp = $this->_HCClientPayment($payload);

            $this->createSysLog('sandbox', $referenceID, $_SERVER['REQUEST_METHOD'], __CLASS__, __METHOD__, 'REFUND', $payload['terminalID'], $payload['terminalIPAddress'], '', $resp['responseInfo']);

...
class Payment_controller extends MY_Controller
{
    ...
    private function _HCClientPayment($body = [])
    {
        ...
        $body = [
            ...
            'merchantCategoryCode' => $this->defaultParameterSandbox->merchantCategoryCode,
            'merchantId' => $this->defaultParameterSandbox->merchantID,
            'merchantName' => $this->defaultParameterSandbox->merchantName,
